...
const IconRemoveCircleRounded = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg
        fill="none"
        height="1em"
        ref={ref}
...
const ForwardRef = forwardRef(IconRemoveCircleRounded);
export { ForwardRef as IconRemoveCircleRounded };
