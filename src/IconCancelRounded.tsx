...
const IconCancelRounded = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg
        fill="none"
        height="1em"
        ref={ref}
...
const ForwardRef = forwardRef(IconCancelRounded);
export { ForwardRef as IconCancelRounded };
