...
const IconAddCircleOutlineRounded = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg
        fill="none"
        height="1em"
        ref={ref}
...
const ForwardRef = forwardRef(IconAddCircleOutlineRounded);
export { ForwardRef as IconAddCircleOutlineRounded };
