...
const IconEmptyCheckList = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg
        fill="none"
        height="1em"
        ref={ref}
        ...
        {...props}
    >
        <g clipPath="url(#clip0_4229_32360)">
            <path
                clipRule="evenodd"
        ...
        <defs>
            <clipPath id="clip0_4229_32360">
                <rect fill="currentColor" height={24} width={24} />
            </clipPath>
        </defs>
    </svg>
);
const ForwardRef = forwardRef(IconEmptyCheckList);
