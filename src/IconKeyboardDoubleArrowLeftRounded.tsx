...
const SvgComponent = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg fill="none" height="1em" ref={ref} viewBox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    />
    <path
      d="M11.7 17.2905C12.09 16.9005 12.09 16.2705 11.7 15.8805L7.82998 12.0005L11.71 8.12047C12.1 7.73047 12.1 7.10047 11.71 6.71047C11.32 6.32047 10.69 6.32047 10.3 6.71047L5.70998 11.3005C5.31998 11.6905 5.31998 12.3205 5.70998 12.7105L10.3 17.3005C10.68 17.6805 11.31 17.6805 11.7 17.2905Z"
      fill="currentColor"
    />
  </svg>
);
