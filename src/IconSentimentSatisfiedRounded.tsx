...
const IconSentimentSatisfiedRounded = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg
        fill="none"
        height="1em"
        ref={ref}
...
const ForwardRef = forwardRef(IconSentimentSatisfiedRounded);
export { ForwardRef as IconSentimentSatisfiedRounded };
