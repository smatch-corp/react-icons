...
const IconBookmarkFillRounded = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg
        fill="none"
        height="1em"
        ref={ref}
...
const ForwardRef = forwardRef(IconBookmarkFillRounded);
export { ForwardRef as IconBookmarkFillRounded };
